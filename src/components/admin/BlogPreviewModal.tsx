            ...
            <div className="bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
              ...
              <div className="max-h-[80vh] overflow-y-auto">
                ...
                <div className="px-6 py-6">
                  ...
                  {/* Render HTML content */}
                  <article className="prose prose-lg max-w-none mt-6 text-gray-900 prose-headings:text-gray-900 prose-p:text-gray-800 prose-strong:text-gray-900 prose-li:text-gray-800 prose-blockquote:text-gray-800 prose-code:text-gray-900 prose-a:text-blue-600">
