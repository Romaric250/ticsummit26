  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.error || "Failed to create alumni")
      }
    } catch (error) {
      ...
      <div className="min-h-screen bg-gray-50 pt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Create New Alumni</h1>
              <p className="text-gray-600 mt-1">Add a new alumni profile to the system</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-end space-x-4">
              ...
              <Button 
                type="submit" 
                disabled={loading || !formData.name || !formData.email || !formData.slug || countWords(formData.bio) > 75 || countWords(formData.bio) === 0}
